...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
       {/* START: ADDED HEAD for SEO and JSON-LD */}
       <Head>
      ...
      {/* END: ADDED HEAD for SEO and JSON-LD */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center">
           ...
           <div className="mt-16 md:mt-24 max-w-4xl mx-auto">
            {/* What is the SLIIT GPA Calculator */}
            <div className="mb-12">
            ...
            <div className="mb-12">
                ...
                {/* This uses the existing grading scale section, we can add a more detailed table here if needed */}
            </div>
            ...
            {/* Proven Strategies to Raise GPA */}
            <div>
