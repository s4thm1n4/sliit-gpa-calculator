...
export default function BusinessFacultyPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
        <Head>
            <title>SLIIT Faculty of Business GPA Calculator</title>
            <meta name="description" content="Calculate your SLIIT Business faculty GPA for MBA, Business Administration, Marketing, HR and Accounting programs." />
            <meta name="keywords" content="SLIIT Business GPA, MBA GPA Calculator, Business Administration GPA, SLIIT Marketing GPA" />
        </Head>
